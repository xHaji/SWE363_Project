      ...
      <div className="charts-section">
        <div className="chart">
          ...
          <div className="chart-stats">
            <div><span>Shortlisted</span><strong>42</strong></div>
            <div><span>Hired</span><strong>8</strong></div>
            <div><span>Rejected</span><strong>50</strong></div>
          </div>
        </div>

        {/* Recent Saved Jobs Table */}
        <div className="table-section">
          <h3>Recent Saved Job</h3>
